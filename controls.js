...
function exitFullScreenMode() {
    ...
    setTimeout(() => {
        ...
        // 2. DỌN SẠCH trước khi trả về
        if (compass) {
            // Xóa style đã ép bởi applyDynamicScaling
