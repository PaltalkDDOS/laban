...
function handleInteraction(e) {
    ...
    if (e.target.closest('.compass-container') || e.target.closest('.fs-icon')) {
        e.preventDefault();
...
// Double Tap Mobile - Tối ưu cho tất cả trình duyệt
...
document.addEventListener('touchend', (e) => {
    ...
    // Chỉ double tap khi là 1 ngón tay
    if (touchCount === 1 && currentTime - lastTapTime < 420) {
        handleInteraction(e);
    }
...
function toggleFullScreenMode() {
    ...
    // La bàn to theo tỷ lệ màn hình thực tế
    fsDiv.innerHTML = `
        <div id="fs-compass-wrapper" style="width: min(96vw, 560px); height: min(96vw, 560px); display: flex; align-items: center; justify-content: center;"></div>
        <div id="fs-status-wrapper" style="width: 92%; max-width: 500px; margin-top: 28px;"></div>
        
        <!-- Nút thoát full -->
        <div onclick="exitFullScreenMode()" style="position:absolute; top:20px; right:20px; color:#f1c40f; font-size:2rem; cursor:pointer; z-index:10000;">✕</div>
    `;
